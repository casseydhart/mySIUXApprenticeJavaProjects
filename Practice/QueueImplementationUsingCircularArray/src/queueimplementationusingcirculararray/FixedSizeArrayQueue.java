package queueimplementationusingcirculararray;
/**
...
public class FixedSizeArrayQueue 
{
	...
	// Inserts an element at the rear of the queue. The method runs in O(1) time.
	...
	// Checks whether the queue is full. This method runs in O(1) tim.
