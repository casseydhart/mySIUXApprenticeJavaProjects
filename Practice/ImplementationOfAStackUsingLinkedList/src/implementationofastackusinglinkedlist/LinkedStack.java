package implementationofastackusinglinkedlist;
/**
...
public class LinkedStack 
{
	...
	// Constructor: Crates an empty stack.
	public LinkedStack()
	{
		length = 0;
		top = null;
	...
	// EmptyStackEcveption if the stack is empty.
	...
	// Returns the number of elements in th stack.
	public int size()
	{
		return length;
	}
